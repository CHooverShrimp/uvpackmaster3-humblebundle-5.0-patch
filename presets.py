...
class UVPM3_OT_SavePresetBase(bpy.types.Operator):
    ...
    def get_collection_props(self, context):
        return get_scene_props(context)
...
class UVPM3_OT_LoadPresetBase(bpy.types.Operator):
    ...
    def translate_props_20to21(self, props_dict):
        def init_desc(name_prefix):
            ...
            desc = {
                'enable' : props_dict[enable_prop_id],
                'group_num' : props_dict[num_prop_id]
            }
...
class UVPM3_OT_ResetToDefaults(OpConfirmationMsgMixin, UVPM3_OT_LoadPresetBase):
    ...
    def execute(self, context):
        ...
        self.set_props(scene_props, props_dict, self.props_to_load)
