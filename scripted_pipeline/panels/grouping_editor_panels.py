...
class UVPM3_PT_GroupingEditor(UVPM3_PT_GenericGroupingEditor, UVPM3_PT_Grouping):

    bl_idname = 'UVPM3_PT_GroupingEditor'
    bl_label = 'Grouping Editor'


class UVPM3_PT_SchemeGroupsGroupingEditor(UVPM3_PT_GenericGroupingEditor, UVPM3_PT_SchemeGroups):

    bl_idname = 'UVPM3_PT_SchemeGroupsGroupingEditor'
    bl_parent_id = UVPM3_PT_GroupingEditor.bl_idname


class UVPM3_PT_GroupTargetBoxesGroupingEditor(UVPM3_PT_GenericGroupingEditor, UVPM3_PT_GroupTargetBoxes):
