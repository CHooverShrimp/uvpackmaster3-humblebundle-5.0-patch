...
class UVPM3_SavedPanelSettings(bpy.types.PropertyGroup):
...
class UVPM3_OT_SelectMultiPanel(bpy.types.Operator, PanelIdAttributeMixin):
...
class UVPM3_OT_ExpandPanel(bpy.types.Operator, PanelIdAttributeMixin):
...
class UVPM3_PT_MultiPanels(bpy.types.Panel, PanelUtilsMixin):
    ...
    def draw_panel_header(self, context, panel_data, panel, layout):
        ...
        if not supported:
            ...
            UVPM3_OT_WarningPopup.draw_operator(warning_row, text=not_supported_msg)
