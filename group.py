...
class UVPM3_GroupOverrides():
    ...
    override_pack_to_single_box : BoolProperty(
        name='Override {}'.format(Labels.PACK_TO_SINGLE_BOX_NAME),
        description=Labels.OVERRIDE_GLOBAL_OPTION_DESC,
        default=OVERRIDE_PROPERTY_DEFAULT)
    ...
    override_pack_strategy : BoolProperty(
        name='Override {}'.format(Labels.PACK_STRATEGY_NAME),
        description=Labels.OVERRIDE_GLOBAL_OPTION_DESC,
        default=OVERRIDE_PROPERTY_DEFAULT)
    ...
    def __init__(self, name=None, num=None):
        ...
        self.override_pack_to_single_box = self.OVERRIDE_PROPERTY_DEFAULT
        self.pack_to_single_box = PropConstants.PACK_TO_SINGLE_BOX_DEFAULT

        self.override_pack_strategy = self.OVERRIDE_PROPERTY_DEFAULT
