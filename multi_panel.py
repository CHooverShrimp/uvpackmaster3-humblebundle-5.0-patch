...
class UVPM3_SavedMultiPanelSettings(bpy.types.PropertyGroup):
...
MULTI_PANEL_ID_ADDON_OPTIONS = 'addon_options'
...
MULTI_PANELS = [
    ...
    MultiPanel(id=MULTI_PANEL_ID_ADDON_OPTIONS, name='ADD-ON OPTIONS', icon='SETTINGS')
]
